// ClockworkPi PicoCalc with optional joystick connected to side connector
// We assume a Raspberry Pico RP2040 + built-in ILI9488 display.
...
#define KEY_LEFT    2  // Pico pin 4
#define KEY_RIGHT   3  // Pico pin 5
#define KEY_FIRE    21  // Pico pin 27
#define KEY_UP      4  // Pico pin 6
#define KEY_DOWN    5  // Pico pin 7
...
#define st77_sck 10          // Sometimes called SCL or clock.
#define st77_mosi 11         // Sometimes called SDA.
#define st77_rst 15          // -1 if your display lacks a reset pin.
#define st77_dc 14
#define st77_cs 13          // -1 if your display lacks a CS pin.

/* Software SPI:
 *
 * If you want to go fast with SPI transfers (less display update latency)
 * you can use the bit banging software SPI implementation. I suggest first
...
#define st77_width 320      // Display width and height.
#define st77_height 320     // Check your display for the correct order.
#define st77_landscape 0    // Portrait or landscape. You want landscape.
#define st77_mirror_x 1     // X mirroring, if needed.
#define st77_mirror_y 0     // Y mirroring, if needed.
...
#define st77_isbgr 1        // Set to 1 if it's a BGR and not RGB display.
